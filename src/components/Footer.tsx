...
import { footerData, socialLinks, ctaLinks } from "@/data/content";
            ...
            <div className="mt-6 flex gap-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-white/50 transition-all hover:border-white/30 hover:text-white"
